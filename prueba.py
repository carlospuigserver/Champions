...
print("El archivo '23-24_actualizado_con_predicciones.csv' ha sido guardado correctamente. Solo los resultados de ida de los octavos de final han sido actualizados con las predicciones.")
