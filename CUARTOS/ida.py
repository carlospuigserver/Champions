...
ruta_archivo_23_24 = 'OCTAVOS/OctavosVuelta.csv'
...
predicciones_ida_23_24 = pipeline.predict(X_23_24_cuartos)
...
# Actualizar solo las filas de los cuartos de final con las predicciones de 'resultado_ida'
df_23_24.loc[df_23_24['fase'] == 'cuartos', 'resultado_ida'] = df_23_24.loc[df_23_24['fase'] == 'cuartos', 'resultado_ida_pred']

# Eliminar la columna temporal de predicciones
df_23_24.drop(columns=['resultado_ida_pred'], inplace=True)

# Guardar el DataFrame actualizado en un nuevo archivo CSV
df_23_24.to_csv('CUARTOS/CuartosIda.csv', index=False)

print("El archivo 'CuartosIda.csv' ha sido guardado correctamente. Solo los resultados de ida de los cuartos de final han sido actualizados con las predicciones.")
