...
X = df_entrenamiento_total[['equipo_local', 'equipo_visitante']]
y = df_entrenamiento_total['resultado_ida'].astype(str)
...
# Calcular la precisión del modelo y generar un reporte de clasificación
